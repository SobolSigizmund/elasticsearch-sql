...
rm -f test_build_key || { echo "Error: Cleaning test binaries zip"; exit 1; }
...
zip test_build_key $(git ls-files -o | grep -e target/test-classes/.*class) || { echo "Error: Zipping test binaries failed"; exit 1; }
echo "Zipping artifacts DONE!!!"
# Modified by Insights Service at 2016-04-29 12:36:21.994957
